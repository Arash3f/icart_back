from sqlalchemy import UUID, Column, ForeignKey, String,Float,TEXT,Integer
...
class Organization(Base, BaseMixin):
    ...
    location = relationship("Location",foreign_keys=[location_id],back_populates="organizations")
